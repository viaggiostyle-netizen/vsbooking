    ...
    <div className="animate-apple-in space-y-4">
      <div className="relative group">
        ...
        <div className="relative">
          <div className="absolute left-10 top-1/2 -translate-y-1/2 text-muted/60 transition-colors group-focus-within:text-foreground">
            <Mail size={18} />
          </div>
          <Input
            value={email}
            ...
            className="h-[54px] w-full rounded-2xl border-border/50 bg-background !pl-[94px] pr-4 text-[16px] text-foreground placeholder:text-muted/40 transition-all focus:border-foreground/20 focus:ring-4 focus:ring-foreground/[0.03]"
          />
        </div>
      </div>
